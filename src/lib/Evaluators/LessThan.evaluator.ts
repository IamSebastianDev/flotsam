    ...
    return (value: unknown, propertyName?: string) => {
        ...
        if (typeof value !== 'number') {
            throw new FlotsamEvaluationError(
                `Evaluator 'LessThan' can only be used for values that are of type 'Number', received type ${typeof value}`
            );
        }
...
export const LessThanOrEqual = (condition: number, options: EvaluatorOptions = {}): EvaluatorFunction => {
    ...
    return (value: unknown, propertyName?: string) => {
        if (typeof value !== 'number') {
            ...
            throw new FlotsamEvaluationError(
                `Evaluator 'LessThanOrEqual' can only be used for values that are of type 'Number', received type ${typeof value}`
            );
        }
